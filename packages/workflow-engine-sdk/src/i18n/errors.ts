...
export const SDKErrors = {
  ...
  // Engine API errors
  MsgSDKEngineReplyInvalidData: fe('KA140614', "Engine API reply for request %s invalid: %s"),
  MsgSDKEngineReplyInvalidType: fe('KA140615', "Engine API reply type for request %s invalid: %s"),
  MsgSDKEngineReqNoActiveRequest: fe('KA140616', 'No engine handler is active on the supplied context'),
  MsgSDKEngineFailMarshalEngineRequest: fe('KA140617', 'Failed to marshal engine request data'),
  MsgSDKEngineFailSendEngineRequest: fe('KA140618', 'Failed to send engine request'),
